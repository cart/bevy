...
#[derive(Clone, Debug, TypeUuid)]
#[uuid = "ebfc1d11-a2a4-44cb-8f12-c49cc631146c"]
pub struct PipelineDescriptorV2 {
    pub name: Option<String>,
    pub layout: PipelineLayout,
    pub shader_stages: ShaderStagesV2,
    pub primitive: PrimitiveState,
    pub depth_stencil: Option<DepthStencilState>,
    pub multisample: MultisampleState,
...
impl PipelineDescriptorV2 {
    pub fn new(shader_stages: ShaderStagesV2, layout: PipelineLayout) -> Self {
        PipelineDescriptorV2 {
            name: None,
            layout,
            color_target_states: Vec::new(),
            depth_stencil: None,
    ...
    pub fn default_config(shader_stages: ShaderStagesV2, layout: PipelineLayout) -> Self {
        PipelineDescriptorV2 {
            name: None,
            primitive: PrimitiveState {
                topology: PrimitiveTopology::TriangleList,
