...
#[derive(Default)]
pub struct DrawFunctionSpritePlugin;

impl Plugin for DrawFunctionSpritePlugin {
    fn build(&self, app: &mut App) {
        ...
        app.sub_app_mut(0)
            ...
            .add_system_to_stage(RenderStage::Draw, sprite_bind_group_system.system()) // TODO: this is ugly
