...
pub struct MeshMaterial2d<M: Material2d>(#[template] pub Handle<M>);
...
pub struct RenderMaterial2dInstances(MainEntityHashMap<RenderMaterial2dInstance>);

pub struct RenderMaterial2dInstance {
    pub(crate) asset_entity: Entity,
...

    {
        ...
        for (view_entity, view, visible_entities) in &views {
            ...
            for (render_entity, visible_entity) in dirty_specializations.iter_to_specialize(
                ...
                let Some(material_2d) = render_materials
                ...
                work_items.push(Specialization2dWorkItem {
                    ...
                    material_type_id: material_instance.type_id(),
                });
            }
        }
    }
