...
use bevy_render::{pipeline::{BindGroupDescriptorId, PipelineDescriptor, PipelineId}, renderer::{BindGroupId, BufferId, BufferInfo, RenderResourceId, SamplerId, TextureId}, shader::{Shader, ShaderId}, texture::TextureDescriptor};
...
pub struct WgpuResourcesReadLock<'a> {
    ...
    pub render_pipelines_v2:
        RwLockReadGuard<'a, HashMap<PipelineId, wgpu::RenderPipeline>>,
