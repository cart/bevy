...
mod tests {
    ...
    fn world_instance_spawns_and_respawns_after_change() {
        ...
        app.world_mut().entity_mut(handle.entity()).insert(world_1);
        ...
        app.world_mut().entity_mut(handle.entity()).insert(world_2);
