...
fn setup(mut commands: Commands) {
    ...
    let cube_handle = commands.spawn_asset(Mesh::from(Cuboid::new(4.0, 4.0, 4.0)));
    let cube_material_handle = commands.spawn_asset(StandardMaterial {
    ...
    let cube_size = 4.0;
    let cube_handle =
        commands.spawn_asset(Mesh::from(Cuboid::new(cube_size, cube_size, cube_size)));
