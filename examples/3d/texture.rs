...
fn setup(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    let quad_width = 8.0;
    let quad_handle =
        commands.spawn_asset(Mesh::from(Rectangle::new(quad_width, quad_width * aspect)));
    ...
    let red_material_handle = commands.spawn_asset(StandardMaterial {
    ...
    let blue_material_handle = commands.spawn_asset(StandardMaterial {
