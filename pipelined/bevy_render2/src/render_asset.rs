...
use bevy_ecs::{
    prelude::*,
    system::{lifetimeless::*, StateSystem, SystemParam, SystemParamItem, SystemState},
};
...
impl<A: RenderAsset> Plugin for RenderAssetPlugin<A> {
    fn build(&self, app: &mut App) {
        ...
        let prepare_system_state = SystemState::new(&mut render_app.world);
        render_app
            ...
            .add_system_to_stage(
                RenderStage::Prepare,
                PrepareAssetSystem::<A> {
                    system_state: prepare_system_state,
                },
            );
    }
}
...
pub struct PrepareAssetSystem<R: RenderAsset> {
    system_state: SystemState<RenderAssetParams<R>>,
}

impl<R: RenderAsset> StateSystem for PrepareAssetSystem<R> {
